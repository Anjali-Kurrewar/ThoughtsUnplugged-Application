  ...
  return (
    <div className='relative bg-custom-white w-full scroll-smooth pt-8 pb-20 h-full '>
      <nav className=' relative bg-custom-white '>
        ...
        <div className='absolute w-[10rem] h-[10rem] md:w-[18rem] md:h-[18rem]  bg-gradient-to-r from-main-color1 to-main-color2 rounded-2xl left-1/2 top-[14rem] md:left-[52rem] md:top-[28rem] '></div>
        ...
        <div className='absolute md:mx-[24rem] md:mt-[10rem] md:w-[40rem] md:h-[34rem] mx-4 mt-20 w-full bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100'>
          <div className='absolute'>
          <div >
          <h1 className=' text-gray-600 text-md font-merriweather pl-[3rem] pt-6 mb-2'>Full Name:</h1>
            <input type='text' className=' border border-gray-300 w-[34rem]  text-gray-900 bg-gray-50 rounded-lg p-2.5 focus:ring-black focus:border-black  ml-[3rem]' placeholder="John" required/>  
          </div>
          <div>
          <h1 className=' text-gray-600 text-md font-merriweather pl-[3rem] pt-4 mb-2'>Email:</h1>
            <input type='text' className=' border border-gray-300 w-[34rem]  text-gray-900 rounded-lg p-2.5 bg-gray-50 focus:ring-black focus:border-black  ml-[3rem]' placeholder="Johndoe@gmail.com" required/>  
          </div>
          <div>
          <h1 className='text-gray-600 text-md font-merriweather pl-[3rem] pt-4 mb-2'>Subject:</h1>
            <input type='text' className='border border-gray-300 w-[34rem]  text-gray-900 rounded-lg p-2.5 bg-gray-50 focus:ring-black focus:border-black  ml-[3rem]' placeholder="Write you subject here..." required/>  
          </div>
          <div>
            <label for="message" class="block mb-2 text-md font-merriweather text-gray-600 pl-[3rem] pt-4">Your message:</label>
            <textarea id="message" rows="4" class="block p-2.5 w-[34rem] ml-[3rem] text-md text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-black focus:border-black" placeholder="Write your thoughts here..."></textarea>
          </div> 
    ...
    <div className='absolute w-full h-[30rem] mt-[4rem]'>
          <Footer1/>
    </div>
    <div className='absolute w-full h-[20rem] mt-[30rem]'>
          <Footer2/>
    </div>
    </div>
