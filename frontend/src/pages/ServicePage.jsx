  ...
  return (
    <div className='relative bg-custom-white w-full scroll-smooth pt-8 pb-20 h-full '>
      <nav className=' relative bg-custom-white '>
        ...
        {/* Service 1 */}
        <div className='flex flex-col bg-custom-blue shadow-2xl rounded-e-3xl w-auto mr-[10rem] h-[20rem] mt-10 relative'>
             <h1 className='text-custom-white text-5xl font-calistoga pl-2 pt-8'>Recipe Development and Sharing</h1>
             <p className='font-merriweather text-md text-gray-200 mt-10 pl-4 pr-[28rem] text-justify'>
             ...
             <div className='absolute top-0 right-0 h-full w-auto pl-[44rem]'>
               <img src='./service.jpg' alt='service1' className='rounded-e-3xl h-full w-auto pl-[8rem] object-cover'/>
             </div>
            </div>
            {/* Service 2 */}
            <div className='flex flex-col bg-custom-white shadow-2xl rounded-s-3xl w-auto ml-[10rem] h-[20rem] pl-[24rem]  mt-10 relative'>
             <h1 className='text-custom-blue text-5xl font-calistoga pr-2 pt-8'>Restaurant Reviews</h1>
             <p className='font-merriweather text-md text-custom-blue mt-10 pr-4 pl-[0rem] text-justify'>
             ...
             <div className='absolute top-0 right-0 h-full w-auto pr-[44rem]'>
               <img src='./service2.avif' alt='service1' className='rounded-s-3xl h-full w-auto pr-[8rem] object-cover'/>
             </div>
            </div>
            {/* Service 3 */}
            <div className='flex flex-col bg-custom-blue shadow-2xl rounded-e-3xl w-auto mr-[10rem] h-[20rem] mt-10 relative'>
             ...
             <div className='absolute top-0 right-0 h-full w-auto pl-[44rem]'>
               <img src='./service3.jpg' alt='service1' className='rounded-e-3xl h-full w-auto pl-[8rem] object-cover'/>
             </div>
            </div>
            {/* Service 4 */}
            <div className='flex flex-col bg-custom-white shadow-2xl rounded-s-3xl w-auto ml-[10rem] h-[20rem] pl-[24rem]  mt-10 relative'>
             ...
             Whether you're considering the latest kitchen appliance or seeking the best quality ingredients, my reviews provide valuable insights to help you select the best products for your culinary needs. Trust my 
             expertise to guide you through the plethora of options and find the products that enhance your cooking experience.
             </p>
             <div className='absolute top-0 right-0 h-full w-auto pr-[44rem]'>
               <img src='./service4.jpg' alt='service1' className='rounded-s-3xl h-full w-[32rem] pr-[8rem] object-cover'/>
             </div>
            </div>
            {/* Footer */}
            ...
            <div className='absolute w-full h-auto mt-[30rem]'>
              <Footer2/>
            </div>
          </div>
  )
